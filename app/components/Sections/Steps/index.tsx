...
export const Steps = ({ stepsKey }: StepsPropTypes) => {
  ...
  //         <div className="pointer-events-none absolute -bottom-10 left-1/2 z-10 col-span-full grid w-full -translate-x-1/2 grid-cols-4 flex-row items-end justify-between gap-3 px-6 md:grid-cols-8 md:gap-4 lg:bottom-1/2 lg:max-w-[unset] lg:translate-y-1/2 lg:grid-cols-12 lg:p-0 lg:px-6">
