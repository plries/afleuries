    ...
    <>
      ...
      >
        <dialog
          ref={hook.modalRef}
          open={hook.isOpen}
          className={`flex aspect-square w-[calc(100%-3rem)] max-w-md flex-col gap-3 rounded-3xl bg-tan-10 p-6 shadow-lg transition-all duration-700 ease-in-out ${hook.isOpen ? "opacity-100" : "pointer-events-none opacity-0"}`}
        >
